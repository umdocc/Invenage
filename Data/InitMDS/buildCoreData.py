...
## read the inital database and build the prodCodeLU
#conn = sqlite3.connect('initMDS.sqlite')
#saleData = pd.read_sql_query('select * from saleLogBase',conn)
#conn.close()
#
#prodCodeLU = saleData.copy()
#prodCodeLU['prodCode'] = ''
#prodCodeLU = prodCodeLU[~prodCodeLU.chiNguyetCode.duplicated()]
#prodCodeLU = prodCodeLU[~prodCodeLU.chiNguyetCode.str.contains('ADVIA')]

# issue the prodCode table
