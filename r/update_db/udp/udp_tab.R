  ...
  update_product_tab <- tabPanel(
    ...
    fluidRow(
      ...
      box(width = 3, height = 400,
          ...
          textInput(inputId = 'udp_add_prod_code', 
                    label = uielem$prod_code),
          textInput(inputId = 'udp_add_comm_name', 
                    label = uielem$comm_name),
          div(style="display: inline-block;vertical-align:top;width: 150px",
              htmlOutput('udp_add_product_vendor')),
          div(style="display: inline-block;vertical-align:top;width: 120px",
              textInput(inputId = 'udp_add_prod_ref_smn',
                        label = uielem$ref_smn)),
          div(style="display: inline-block;vertical-align:top;width: 90px",
              textInput(inputId = 'udp_add_prod_ordering_unit', 
