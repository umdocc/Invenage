#convert database into lower case format
import sqlite3, pandas as pd
from shutil import copyfile

# tables that need data changed
localisation = pd.read_excel('/Users/cuongdo/Desktop/dbv2.xlsx',
                             sheet_name='localisation')
guess_table = pd.read_excel('/Users/cuongdo/Desktop/dbv2.xlsx',
                             sheet_name='guess_table')
payment_type = pd.read_excel('/Users/cuongdo/Desktop/dbv2.xlsx',
                             sheet_name='payment_type')
output_info = pd.read_excel('/Users/cuongdo/Desktop/dbv2.xlsx',
                             sheet_name='output_info')


#copy old db to new db
db_orig_file = '/Users/cuongdo/Dropbox/MDSCloud/SQLite/Dao.sqlite'
db_dest_file = '/Users/cuongdo/Dropbox/MDSCloud/SQLite/dbv2.sqlite'
